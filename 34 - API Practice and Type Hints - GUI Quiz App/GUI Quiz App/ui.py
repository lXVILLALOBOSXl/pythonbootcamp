...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_image = PhotoImage(file="/Users/luisvillalobos/Documents/Programacion/Self Study/Udemy/Python Bootcamp/34 - API Practice and Type Hints - GUI Quiz App/GUI Quiz App/images/true.png")
        self.true_button = Button(image=self.true_image, highlightthickness=0, command=self.true_pressed)
        self.true_button.grid(row=2, column=0)

        self.false_image = PhotoImage(file="/Users/luisvillalobos/Documents/Programacion/Self Study/Udemy/Python Bootcamp/34 - API Practice and Type Hints - GUI Quiz App/GUI Quiz App/images/false.png")
